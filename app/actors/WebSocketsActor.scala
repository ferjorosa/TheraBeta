...
class WebSocketsActor extends Actor{
  // this map relate every device with his DeviceChannel
  // var...
...
case class StartWebSocket(deviceID: Int) extends WebSocketMessage

case class WebSocketClosed(deviceID: Int)extends WebSocketMessage

case class newMessageWS(deviceID: Int,msg:String) extends WebSocketMessage